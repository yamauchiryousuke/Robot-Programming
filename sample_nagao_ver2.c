    ...
    for (int n=0;n<ball_num;n++){
        ...
        //if(n>0){
            /*for (int nn=0;nn<n;nn++){
                ...
                if(disbb<=2*balls[n].r){
                    balls[n].Vx=(-balls[n].Vx+balls[n-nn].Vx)*(1+el)/(balls[n].mb/balls[n-nn].mb+1)+balls[n].Vx;
                    balls[n].Vy=(-balls[n].Vy+balls[n-nn].Vx)*(1+el)/(balls[n].mb/balls[n-nn].mb+1)+balls[n].Vy;
                    //balls[n-nn].Vx=(-balls[n-nn].Vx+balls[n].Vx)*(1+el)/(balls[n-nn].mb/balls[n].mb+1)+balls[n-nn].Vx;
                    //balls[n-nn].Vy=(-balls[n-nn].Vy+balls[n].Vx)*(1+el)/(balls[n-nn].mb/balls[n].mb+1)+balls[n-nn].Vy;
                }
